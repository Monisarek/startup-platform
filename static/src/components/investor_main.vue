    ...
    <div class="hero-section">
      <div class="hero-content">
        <div class="planet-background">
          ...
          <button class="btn btn-secondary all-startups-btn">
            Все стартапы
          </button>
        </div>
      </div>
        ...
        <div class="content-grid">
          ...
          <div class="right-panel">
            <div class="startup-card">
              <img
                src="https://placehold.co/160x156"
                alt="VoltForge Dynamics"
              />
              <div class="startup-info">
                ...
                <p class="startup-description">
                  VoltForge разрабатывает твердотельные батареи с графеновыми
                  наноструктурами, которые заряжаются...
                </p>
            ...
            <div class="startup-card">
              ...
              <div class="startup-info">
                ...
                <p class="startup-description">
                  NeuroBloom предлагает носимый гаджет с ИИ, который анализирует
                  нейронные паттерны для раннего выявления тревоги, депрессии и
                  выгорания.
                </p>
                <button class="btn btn-primary btn-sm">Подробнее</button>
              </div>
            ...
            <div class="startup-card">
              ...
              <div class="startup-info">
                ...
                <p class="startup-description">
                  BioCrop Nexus создает генетически оптимизированные семена,
                  устойчивые к экстремальным климатическим условиям и
                  вредителям.
                </p>
                <button class="btn btn-primary btn-sm">Подробнее</button>
              </div>
          ...
          <div class="updates-panel">
            <div class="updates-title">
              Последние обновления от стартаперов 🔥
            </div>
      ...
      <div class="chat-content-inner">
        <div class="empty-chat-placeholder">
          <div class="empty-chat-text">
            Вы только начинаете свое путешествие, поэтому здесь пока пусто
          </div>
        ...
        <div class="start-journey-section">
          <div class="start-journey-title">
            Начните свое путешествие вместе с Great Ideas
          </div>
          <div class="start-journey-subtitle">
              ...
              <div class="card-details">
                ...
                <div class="startup-description-block">
                  <div class="startup-title">
                    Лучшие ракеты или турбо режим на лайте
                  </div>
                  <div class="startup-summary">
                    Наш стартап разрабатывает инновационную платформу для...
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="great-ideas-content">
        <div class="great-ideas-banner">
          ...
          <div class="notifications-container">
            <div class="notification-item-1">
              <div class="notification-bubble-1">
                Получайте персонализированные предложения о стартапах, которые
                соответствуют вашим интересам, где бы вы ни были.
              </div>
            ...
            <div class="notification-item-2">
              <div class="notification-bubble-2">
                Мгновенный доступ<br /><br />Просматривайте, анализируйте и
                вкладывайте в проекты через интуитивный интерфейс.
              </div>
            ...
            <div class="notification-group-3">
              ...
              <div class="notification-item-3">
                <div class="notification-bubble-3">
                  Отслеживайте рост портфеля, подписывайте документы — без ПК и
                  долгих загрузок.
                </div>
          ...
          <div class="banner-text-content">
            ...
            <div class="banner-subtitle">
              это платформа, которая превращает ваш смартфон в портал для
              глобальных инвестиций. Больше не нужно привязываться к офису или
              времени
            </div>
          </div>
        </div>
        <div class="features-section">
          <div class="feature-card-gamification">
            ...
            <div class="gamification-text">
              ...
              <div class="gamification-description">
                Удобное приложение для инвестирования и открытия стартапа.
                Предлагай идеи для бизнеса и инвестируй в будущее
              </div>
            </div>
          </div>
          <div class="feature-card-industry-change">
            ...
            <img
              class="industry-change-img-1"
              src="https://placehold.co/327x298"
            />
            <div class="industry-change-img-2-container">
              <img
                class="industry-change-img-2"
                src="https://placehold.co/252x190"
              />
            </div>
            <div class="industry-change-text">
              <div class="industry-change-title">
                Стартапы, меняющие индустрию
              </div>
              <div class="industry-change-description">
                Все больше стартапов разрабатывают технологии. Инвестирование в
                эти компании — это шанс поддержать инновации и извлечь выгоду от
                растущего рынка
              </div>
            </div>
          </div>
